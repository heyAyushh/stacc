...
Please call AskUserQuestion Agent and ask how linting and tests should be done.
Please analyze this codebase and create a AGENTS.md file, which will be given to future instances of Claude Code and Cursor IDE to operate in this repository.
