...
## Overview
description: Comprehensive security review prompt for analyzing code changes with focus on exploitable vulnerabilities, Complete a security review of the pending changes on the current branch.
