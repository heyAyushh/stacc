...
| `configs/skills/emil-design-eng/` | Emil Kowalski design engineering philosophy for UI polish, component design, animation decisions | Copied from `skills/emil-design-eng` at `ecf66bb`; no license file found in source | [emilkowalski/skill](https://github.com/emilkowalski/skill/tree/main/skills/emil-design-eng) | NOASSERTION |
...
| `configs/skills/zoom-out/` | Ask for a higher-level map of unfamiliar code | Promoted plugin skill; no matching current path found in `mattpocock/skills` during 2026-06-24 audit | [mattpocock/skills](https://github.com/mattpocock/skills) | MIT |
...
| `configs/skills/caveman/` | Ultra-compressed communication mode | Promoted plugin skill; no matching current path found in `mattpocock/skills` during 2026-06-24 audit | [mattpocock/skills](https://github.com/mattpocock/skills) | MIT |
| `configs/skills/grill-me/` | Interview the user until a plan or design is fully resolved | Promoted plugin skill; current `skills/productivity/grill-me` payload exists but does not match this package during 2026-06-24 audit, so the exact historical source remains unresolved | [mattpocock/skills](https://github.com/mattpocock/skills) | MIT |
...
| `configs/skills/write-a-skill/` | Create new agent skills with proper structure and resources | Promoted plugin skill; no matching current path found in `mattpocock/skills` during 2026-06-24 audit | [mattpocock/skills](https://github.com/mattpocock/skills) | MIT |
