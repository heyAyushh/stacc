...
| `configs/stacks/product-docs/` | Outside-in, feature-by-feature product behavior documentation and verification workflow | Copied from the Product Description Gist at `f9435a3`; renamed to `product-docs`, payload layout normalized to `SKILL.md` plus `references/`, and provenance frontmatter added; the Gist publishes no license, so no reuse license is asserted here | [steveruizok/Product Description Gist](https://gist.github.com/steveruizok/83ae5c53f2784ebf8f5fe0a3fb94480f) | LicenseRef-No-Published-License |
...
| `configs/plugins/codex/plugins.json` | Optional Codex plugin marketplace entries | Opt-in remote references; no plugin payloads are vendored | [LazyCodex](https://github.com/code-yeongyu/lazycodex) and [Compound Engineering](https://github.com/EveryInc/compound-engineering-plugin) | MIT |
...
| `configs/stacks/rust/rust-guidelines/` | Microsoft Pragmatic Rust Guidelines for agent-assisted Rust development | Snapshot of the linked generated `all.txt` fetched 2026-08-15; website artifact SHA-256 `c9f1ac1c9d52a65e0c4d524e6a5c2eb80a33669b8b26b7537f0d66a555f432f7`; upstream HEAD `bbf7b03` | [microsoft.github.io/rust-guidelines/agents/all.txt](https://microsoft.github.io/rust-guidelines/agents/all.txt) | MIT |
...
- LazyCodex and Compound Engineering optional marketplace references: MIT
- Product Description Gist: LicenseRef-No-Published-License
